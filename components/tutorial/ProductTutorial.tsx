...
const ProductTutorial: React.FC = () => {
  ...
  const cleanupTargets = () => {
    document.querySelectorAll('.tutorial-target-designs, .tutorial-target-cart').forEach((el) => {
  ...
  > = {
    'select-design': {
      ...
      content:
        'Choose a design to apply to this product. You can click on any design to see it on the product.',
