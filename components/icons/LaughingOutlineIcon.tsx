...
function LaughingIcon({
  ...
  titleId,
  ...props
}: LaughingIconProps, svgRef: React.Ref<SVGSVGElement>) {
  return /*#__PURE__*/React.createElement("svg", Object.assign({
    ...
    strokeLinecap: "round",
    strokeLinejoin: "round",
    d: "M7 9.5a1.5 1.5 0 1 1 3 0m4 0a1.5 1.5 0 0 1 3 0M6 12c-1.555.399-4.459 1.234-3.938 3.782c.268 1.26 1.675 1.493 2.438.926C6.338 15.343 4.5 14 6 12m12 0c1.555.399 4.459 1.234 3.938 3.782c-.268 1.26-1.674 1.493-2.438.926C17.662 15.343 19.5 14 18 12"
  }));
}
