      ...
      {showSharePopover && (
        <div className="share-popover popover-overlay" ref={popoverRef}>
          <div className="share-buttons-row">
            ...
            <FacebookShareButton url={shareUrl} quote="Checkout this awesome image that I created!">
            ...
            <RedditShareButton url={shareUrl} title="Checkout this awesome image that I created!">
          ...
          <div className="share-link-row">
            ...
            <span
              className={`copy-feedback ${copyFeedback.success === true ? 'success' : copyFeedback.success === false ? 'error' : ''}`}
            >
