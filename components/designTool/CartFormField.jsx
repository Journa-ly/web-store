...
export default function CartFormField() {
  ...
  const selectedGenerationGroup = Array.isArray(generationsGroups) && generationsGroups.find((group) => group.selected);
  const selectedImage = selectedGenerationGroup && selectedGenerationGroup.generation_group_images.find((image) => image.selected);
