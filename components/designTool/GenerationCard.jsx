...
const GenerationCard = ({generation = {} }) => {
  ...
  const latestPipeline = (
    generation.generation_group_images.length ? generation.generation_group_images[0].pipeline_job : null
  );
  ...
  return (
    <Card>
      <ImageCarousel images={generation.generation_group_images} generationGroupID={generation.id} />
