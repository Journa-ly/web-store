    ...
    <div>
      <div>
        <p className="my-4">
          ...
          request a return on defective goods. Custom products are made to order and cannot be
          returned unless there is a manufacturing defect.
        </p>
        <p className="my-4">
          For damaged items, include photos of the product and packaging to help us resolve the
          issue quickly.
        </p>
        <p className="my-4">
          ...
          <strong>
            ...
            <a href="mailto:team@journa.ai">team@journa.ai</a>.&nbsp;
          </strong>
        </p>
        <p className="my-4">
          <strong>Wrong Address -</strong>
          <span>
            &nbsp;If you or your end customer provide an address that is considered insufficient by
            the courier, the shipment will be returned to our facility. You will be liable for
            reshipment costs once we have confirmed an updated address with you (if and as
            applicable).
          </span>
          &nbsp;
        </p>
        <p className="my-4">
          ...
          <span>
            &nbsp;Shipments that go unclaimed are returned to our facility and you will be liable
            for the cost of a reshipment to yourself or your end customer (if and as applicable).
          </span>
          <br />
          <br />
        ...
        <p className="my-4">
          ...
          concerns about your specific item. <br />
          <br />
        ...
        <p className="my-4">
          ...
          without a justification. As above, your item must be in the same condition that you
          received it, unworn or unused, with tags, and in its original packaging. You’ll also need
        ...
        <p className="my-4">
          ...
          bank or credit card company to process and post the refund too. <br />
          If more than 15 business days have passed since we’ve approved your return, please contact
          us at <a href="mailto:team@journa.ai">team@journa.ai</a>.
        </p>
      </div>
    </div>
  </div>
