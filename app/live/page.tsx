...
export default function LivePage() {
  const { activeLiveStream, isLoading: isLoadingActive, mutate: refreshActive } = useActiveLiveStream();
  const { previousLiveStreams, isLoading: isLoadingPrevious, mutate: refreshPrevious } = usePreviousLiveStreams();

  return (
    <div className="px-2 lg:px-6 mx-auto py-8">
        ...
        {activeLiveStream === null && isLoadingActive ? (
          ...
          <div className="card bg-base-200 text-center">
            <div className="card-body items-center py-12">
              ...
              <p className="text-base-content opacity-70">There are no active live streams at the moment. Check back later!</p>
            </div>
          </div>
        )}
      </section>
      ...
      <section>
        <div className="divider divider-start text-2xl font-semibold mb-8">
          Previous Streams
        </div>
        ...
        {isLoadingPrevious ? (
          ...
          <div className="card bg-base-200 text-center">
            <div className="card-body items-center py-12">
              ...
              <p className="text-base-content opacity-70">There are no previous live streams to display.</p>
            </div>
          </div>
        )}
      </section>
